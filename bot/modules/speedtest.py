...
from bot.helper.telegram_helper.message_utils import auto_delete_message, sendMessage, deleteMessage, sendThumb, editMessage
...
'''
    try:
        pho = sendThumb(text=string_speed, bot=context.bot, message=update.message, photo=path)
